  ...
  <div id="event-create-container" class="col-md-6 offset-md-3">
    ...
    <form action="/profile/update/{{ $Profile->id }}" method="POST" enctype="multipart/form-data">
      ...
      <div class="form-group col-12">
        ...
        <img src="/img/profile_photo/{{ $Profile->profile_photo_path }}" alt="{{ $User->name }}"
      ...
      @if ($User->role_id == 2)
        <div class="form-group col-12">
          ...
          <input type="text" class="form-control" id="graduation" name="graduation"
            placeholder="Insira o nome do curso aqui" value={{ $Profile->graduation }}>
        </div>
        <div class="form-group col-12">
        ...
        <div class="modal-body">
          <form form action="/profile/createExperience" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group col-12">
              ...
              <input type="text" class="form-control" id="experienceInstitutionId" name="experienceInstitution"
