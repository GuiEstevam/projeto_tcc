...
<div class="col-md-10 offset-md-1">
  <div class="row">
    ...
    <div id="profile-info-container" class="col-md-8">
      ...
      @endif
      <h1>{{ $User->name }}</h1>
      <p class="event-city"><ion-icon name="location-outline"></ion-icon> Campus: {{ $Profile->campus }} </p>
      @if($User->role_id = 2)
        <p class="events-participants"><ion-icon name="people-outline"></ion-icon> Cursando: {{$Profile->graduation}} </p>
        <p class="event-owner"><ion-icon name="star-outline"></ion-icon> Semestre: {{$Profile->semester}}°</p>
      @endif
