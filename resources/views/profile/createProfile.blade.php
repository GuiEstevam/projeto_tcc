            ...
            @if ($User->role_id == 2)
                <div class="form-group col-12">
                    ...
                    <input type="text" class="form-control" id="graduation" name="graduation"
                        placeholder="Insira o nome do curso aqui">
                </div>
                <div class="form-group col-12">
                    <label for="title">Em qual semestre você está?</label>
                    <input type="text" class="form-control" id="semester" name="semester"
                        placeholder="Insira o semestre aqui">
                </div>
                ...
                <div class="form-group col-12 mt-3">
                    @foreach ($Experiences as $Experience)
                        <div class="experienceControl col-12 text-right">
                            <a href="#" data-toggle="modal" data-target="#modalExperience{{ $Experience->id }}">
                ...
                <div class="modal-body">
                    <form form action="/profile/createExperience" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-12">
                            ...
                            <input type="text" class="form-control" id="experienceNameId" name="experienceName"
                                placeholder="Insira o nome do curso aqui">
                        </div>
                        <div class="form-group col-12">
                            <label for="title">Instituição de Ensino</label>
                            <input type="text" class="form-control" id="experienceInstitutionId"
                                name="experienceInstitution" placeholder="Insira o nome da instituição aqui">
                        </div>
                        <div class="row">
                            <div class="form-group col-6">
                                <label for="title">Data de ínicio</label>
                                <input type="date" class="form-control" id="experienceFirstDateId"
                                    name="experienceFirstDate">
                            </div>
                            <div class="form-group col-6">
                                <label for="title">Data fim</label>
                                <input type="date" class="form-control" id="experienceLastDateId"
                                    name="experienceLastDate">
                            </div>
                        </div>
                </div>
