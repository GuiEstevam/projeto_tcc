...
@section('content')
    ...
    @if (count($Users) == 1 && $User->role_id != 1)
        <a href="/profile/setAdministrator/" class="col-md-10 offset-md-1 mt-3 administrator-button btn btn-primary">Tornar
            Administrador</a>
    @endif
                ...
                <tbody>
                    @foreach ($Projetos as $Projetos)
                        <tr>
                            ...
                            <td>
                                <a href="/projetos/participantes/{{ $Projetos->id }}"
                                    class="btn btn-primary mt-2 ">Partipantes</a>
